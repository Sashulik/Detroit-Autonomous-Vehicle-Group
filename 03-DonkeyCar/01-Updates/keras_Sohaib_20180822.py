...
from tensorflow.python.keras.layers import Convolution2D, MaxPool2D
...
def default_linear():
    ...
    x = Convolution2D(filters=16, kernel_size=(5, 5), strides=(2, 2), activation='elu')(x)
    x = MaxPool2D(pool_size=(1,1))(x)
    x = Convolution2D(filters=12, kernel_size=(3, 3), strides=(2, 2), activation='elu')(x)
